# Documentación de Endpoints — Barud API
...
- [Productos](#productos--apiproductos)
- [Pedidos](#pedidos--apipedidos)
- [Detalles de Pedido](#detalles-de-pedido--apidetalles-pedido)
- [Cuentas](#cuentas--apicuentas)
- [Divisiones de Cuenta](#divisiones-de-cuenta--apidivisiones-cuenta)
- [Pagos](#pagos--apipagos)
- [Empleados](#empleados--apiempleados)
- [Mesas](#mesas--apimesas)
- [Vistas / Consultas](#vistas--apivistas)
